...
namespace WebProxy.DiyTransform.End
{
    public class W3CLoggerTransformEnd : DiyResponseTransform
    {
        ...
        public W3CLoggerTransformEnd(ILogger logger, bool enabled, W3CLevel level, string logName) : base(logger, enabled)
        {
            _level = level;
            _logName = logName;
        }

        public override async ValueTask DiyApplyAsync(ResponseTransformContext transformContext)
        {
